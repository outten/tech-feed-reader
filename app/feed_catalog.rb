...
module FeedCatalog
  ...
  CATALOG = [
    ...
    # STUFF #102 — broader PBS show coverage. PBS gates full episodes behind
    # membership, so these are the shows' official YouTube channels (clips,
    # previews, and full episodes where posted). Each channel_id was title-
    # verified against the live feed before adding.
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCcBp_9YPyma4c3HTadmRJ3Q',
      title: 'Nature on PBS', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'PBS\'s flagship wildlife and natural-history documentary series (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCpxYSWgxVt3Pyn1ovXsGQ0g',
      title: 'PBS Terra', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Science and nature shows from PBS Digital Studios (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UC7_gcs09iThXybpVgjHZ_7g',
      title: 'PBS Space Time', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Astrophysics, cosmology, and theoretical physics, explained (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCq6OAftTQOuUBRdtUDq5SUA',
      title: 'PBS Documentaries', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Feature and short documentaries from across PBS (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCZri-Y6aBcTFrxYMF_ghXQA',
      title: 'Great Performances', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'The best in music, theater, opera, and dance (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UC2s0uKOc2WgB9eGta7cUUEA',
      title: 'Washington Week', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'PBS\'s weekly roundtable on national politics and policy (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCHr2GqhllLpeUkw67ueN1-A',
      title: 'American Masters', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Biographies of the artists who shaped American culture (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCdnJJ2_mzqHwKIX_SmCVHTA',
      title: 'Antiques Roadshow', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Experts appraise antiques and collectibles across America (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UC7jxQ3qqvy-1tQoJ3ZRv0Aw',
      title: 'Masterpiece', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Acclaimed British drama, mystery, and period adaptations (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCnDUknWztWaLs7motsqGwPg',
      title: 'Independent Lens', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Award-winning independent documentary films on PBS (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCcxXj4QG3vZ9MZhh6EUUSSw',
      title: 'Secrets of the Dead', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Forensic investigations into history\'s unsolved mysteries (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCUFrfvd3CeQnguMBHXhrjsw',
      title: 'Ken Burns', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Ken Burns and Florentine Films historical documentaries (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCLrFzxcwT97ROXn3JAiDIqQ',
      title: 'Austin City Limits', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'The longest-running music performance show on television (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCh8m0PvZk3CUiQhakN_JTOw',
      title: 'America\'s Test Kitchen', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Rigorously tested recipes and equipment reviews (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCaKGzfu_hg7NcRxjbZStTFg',
      title: 'Lidia\'s Kitchen', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Lidia Bastianich cooks classic Italian and Italian-American dishes (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCpGcoQ4AmidJSpDUXPZoq8A',
      title: 'Christopher Kimball\'s Milk Street', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Bold global recipes and techniques from Milk Street (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UCdtXmukQ1Vp86Ldl7rOrPAw',
      title: 'Pati\'s Mexican Table', category: :pbs_shows,
      interval: FeedsStore::PUBLISHER_INTERVAL, seed: false,
      blurb: 'Pati Jinich explores authentic Mexican cooking and culture (YouTube).' },
    { url: 'https://www.youtube.com/feeds/videos.xml?channel_id=UC14nOnR7RHUZcrjW8hkRFNw',
