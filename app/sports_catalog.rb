    ...
    'soccer' => {
      ...
      leagues: [
        ...
        },
        {
          ...
          blurb: 'The 48-nation 2026 FIFA World Cup — hosted across the US, Canada & Mexico.',
          # Seeded with the 48 nations for the 2026 cycle (stable ESPN ids).
          # Refresh for the next cycle; the sync also auto-adds any team from a match.
          teams: [
            { slug: 'wc-algeria', name: 'Algeria', short_name: 'ALG', source_provider: 'espn', external_id: '624' },
            { slug: 'wc-argentina', name: 'Argentina', short_name: 'ARG', source_provider: 'espn', external_id: '202' },
            { slug: 'wc-australia', name: 'Australia', short_name: 'AUS', source_provider: 'espn', external_id: '628' },
            { slug: 'wc-austria', name: 'Austria', short_name: 'AUT', source_provider: 'espn', external_id: '474' },
            { slug: 'wc-belgium', name: 'Belgium', short_name: 'BEL', source_provider: 'espn', external_id: '459' },
            { slug: 'wc-bosnia-herzegovina', name: 'Bosnia-Herzegovina', short_name: 'BIH', source_provider: 'espn', external_id: '452' },
            { slug: 'wc-brazil', name: 'Brazil', short_name: 'BRA', source_provider: 'espn', external_id: '205' },
            { slug: 'wc-canada', name: 'Canada', short_name: 'CAN', source_provider: 'espn', external_id: '206' },
            { slug: 'wc-cape-verde', name: 'Cape Verde', short_name: 'CPV', source_provider: 'espn', external_id: '2597' },
            { slug: 'wc-colombia', name: 'Colombia', short_name: 'COL', source_provider: 'espn', external_id: '208' },
            { slug: 'wc-congo-dr', name: 'Congo DR', short_name: 'COD', source_provider: 'espn', external_id: '2850' },
            { slug: 'wc-croatia', name: 'Croatia', short_name: 'CRO', source_provider: 'espn', external_id: '477' },
            { slug: 'wc-curacao', name: 'Curaçao', short_name: 'CUW', source_provider: 'espn', external_id: '11678' },
            { slug: 'wc-czechia', name: 'Czechia', short_name: 'CZE', source_provider: 'espn', external_id: '450' },
            { slug: 'wc-ecuador', name: 'Ecuador', short_name: 'ECU', source_provider: 'espn', external_id: '209' },
            { slug: 'wc-egypt', name: 'Egypt', short_name: 'EGY', source_provider: 'espn', external_id: '2620' },
            { slug: 'wc-england', name: 'England', short_name: 'ENG', source_provider: 'espn', external_id: '448' },
            { slug: 'wc-france', name: 'France', short_name: 'FRA', source_provider: 'espn', external_id: '478' },
            { slug: 'wc-germany', name: 'Germany', short_name: 'GER', source_provider: 'espn', external_id: '481' },
            { slug: 'wc-ghana', name: 'Ghana', short_name: 'GHA', source_provider: 'espn', external_id: '4469' },
            { slug: 'wc-haiti', name: 'Haiti', short_name: 'HAI', source_provider: 'espn', external_id: '2654' },
            { slug: 'wc-iran', name: 'Iran', short_name: 'IRN', source_provider: 'espn', external_id: '469' },
            { slug: 'wc-iraq', name: 'Iraq', short_name: 'IRQ', source_provider: 'espn', external_id: '4375' },
            { slug: 'wc-ivory-coast', name: 'Ivory Coast', short_name: 'CIV', source_provider: 'espn', external_id: '4789' },
            { slug: 'wc-japan', name: 'Japan', short_name: 'JPN', source_provider: 'espn', external_id: '627' },
            { slug: 'wc-jordan', name: 'Jordan', short_name: 'JOR', source_provider: 'espn', external_id: '2917' },
            { slug: 'wc-mexico', name: 'Mexico', short_name: 'MEX', source_provider: 'espn', external_id: '203' },
            { slug: 'wc-morocco', name: 'Morocco', short_name: 'MAR', source_provider: 'espn', external_id: '2869' },
            { slug: 'wc-netherlands', name: 'Netherlands', short_name: 'NED', source_provider: 'espn', external_id: '449' },
            { slug: 'wc-new-zealand', name: 'New Zealand', short_name: 'NZL', source_provider: 'espn', external_id: '2666' },
            { slug: 'wc-norway', name: 'Norway', short_name: 'NOR', source_provider: 'espn', external_id: '464' },
            { slug: 'wc-panama', name: 'Panama', short_name: 'PAN', source_provider: 'espn', external_id: '2659' },
            { slug: 'wc-paraguay', name: 'Paraguay', short_name: 'PAR', source_provider: 'espn', external_id: '210' },
            { slug: 'wc-portugal', name: 'Portugal', short_name: 'POR', source_provider: 'espn', external_id: '482' },
            { slug: 'wc-qatar', name: 'Qatar', short_name: 'QAT', source_provider: 'espn', external_id: '4398' },
            { slug: 'wc-saudi-arabia', name: 'Saudi Arabia', short_name: 'KSA', source_provider: 'espn', external_id: '655' },
            { slug: 'wc-scotland', name: 'Scotland', short_name: 'SCO', source_provider: 'espn', external_id: '580' },
            { slug: 'wc-senegal', name: 'Senegal', short_name: 'SEN', source_provider: 'espn', external_id: '654' },
            { slug: 'wc-south-africa', name: 'South Africa', short_name: 'RSA', source_provider: 'espn', external_id: '467' },
            { slug: 'wc-south-korea', name: 'South Korea', short_name: 'KOR', source_provider: 'espn', external_id: '451' },
            { slug: 'wc-spain', name: 'Spain', short_name: 'ESP', source_provider: 'espn', external_id: '164' },
            { slug: 'wc-sweden', name: 'Sweden', short_name: 'SWE', source_provider: 'espn', external_id: '466' },
            { slug: 'wc-switzerland', name: 'Switzerland', short_name: 'SUI', source_provider: 'espn', external_id: '475' },
            { slug: 'wc-tunisia', name: 'Tunisia', short_name: 'TUN', source_provider: 'espn', external_id: '659' },
            { slug: 'wc-turkiye', name: 'Türkiye', short_name: 'TUR', source_provider: 'espn', external_id: '465' },
            { slug: 'wc-united-states', name: 'United States', short_name: 'USA', source_provider: 'espn', external_id: '660' },
            { slug: 'wc-uruguay', name: 'Uruguay', short_name: 'URU', source_provider: 'espn', external_id: '212' },
            { slug: 'wc-uzbekistan', name: 'Uzbekistan', short_name: 'UZB', source_provider: 'espn', external_id: '2570' },
          ]
        },
        {
    ...
    'tennis' => {
      ...
      leagues: [
        ...
        # tournament to the user's "📅 Following tournaments" list.
        {
          ...
          source_provider: 'espn', external_id: 'australian-open',
        ...
        },
        {
          ...
          source_provider: 'espn', external_id: 'roland-garros',
        ...
        },
        {
          ...
          source_provider: 'espn', external_id: 'wimbledon',
        ...
        },
        {
          ...
          source_provider: 'espn', external_id: 'us-open-tennis',
        ...
        # WTA Finals) close the calendar.
        {
          ...
          region: 'global', country: 'United States', format: :tournament,
          source_provider: 'espn', external_id: 'indian-wells',
        ...
        },
        {
          ...
          region: 'global', country: 'United States', format: :tournament,
          source_provider: 'espn', external_id: 'miami-open',
        ...
        },
        {
          ...
          source_provider: 'espn', external_id: 'monte-carlo-masters',
        ...
        },
        {
          ...
          source_provider: 'espn', external_id: 'madrid-open',
        ...
        },
        {
          ...
          source_provider: 'espn', external_id: 'italian-open',
        ...
        },
        {
          ...
          source_provider: 'espn', external_id: 'canadian-open',
        ...
        },
        {
          ...
          region: 'global', country: 'United States', format: :tournament,
          source_provider: 'espn', external_id: 'cincinnati-open',
        ...
        },
        {
          ...
          source_provider: 'espn', external_id: 'shanghai-masters',
        ...
        },
        {
          ...
          region: 'global', country: 'France', format: :tournament,
          source_provider: 'espn', external_id: 'paris-masters',
        ...
        },
        {
          ...
          source_provider: 'espn', external_id: 'wta-dubai',
        ...
        },
        {
          ...
          source_provider: 'espn', external_id: 'wta-doha',
        ...
        },
        {
          ...
          region: 'global', country: 'China', format: :tournament,
          source_provider: 'espn', external_id: 'wta-beijing',
        ...
        },
        {
          ...
          region: 'global', country: 'China', format: :tournament,
          source_provider: 'espn', external_id: 'wta-wuhan',
        ...
        },
        {
          ...
          region: 'global', country: 'Italy', format: :tournament,
          source_provider: 'espn', external_id: 'atp-finals',
        ...
        },
        {
          ...
          region: 'global', country: nil, format: :tournament,
          source_provider: 'espn', external_id: 'wta-finals',
