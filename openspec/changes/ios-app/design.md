...
- **Phase 14 — Home / "What's On Today" (roadmapped, not yet specced)**: the web's `/` dashboard (today's unread/bookmarked stats, live matches, sports today, to-read/listen/watch-today sections, continue-listening/watching) has no iOS equivalent — the app currently opens straight to "Select an Item." Depends on Phase 13 (continue-listening needs resume-position data to exist first).
